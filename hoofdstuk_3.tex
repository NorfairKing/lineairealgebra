...
\subsubsection*{l)}
$W_{12}$ is een deelruimte van $\mathbb{R} \rightarrow \mathbb{R}$, aangezien de enige functies die hieraan voldoen scalaire vermenigvuldigingen zijn van $f: \mathbb{R} \rightarrow \mathbb{R}: x \mapsto x - \frac{1}{2}$ .\\
