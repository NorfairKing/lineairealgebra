...
Met de opensource ideologie in het achterhoofd zou het in principe zo zijn dat iedereen, elke week na de oefenzitting een oefening of twee zou moeten toevoegen in \LaTeX \ aan de git-repository.
...
Buiten de hierboven vermelde doelen, is het ook de bedoeling om het gebruik van \LaTeX \ aan te sporen alsook het gebruik van version control (voor dit boek wordt github gebruikt).
