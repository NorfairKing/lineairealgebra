...
\section{oef 11}
Als $\{w_1,...,w_n\}$ is vrij dan $\sum_{i=1}^n\lambda_iw_i = 0 \Leftrightarrow \forall i \lambda_i = 0$.
\[
w = \sum_{j = 1}^n \lambda_j\beta_j \rightarrow co_{\beta}(w) = (\lambda_1,...,\lambda_n)
\]
Dit is zo logisch dat ik geen bewijs kan bedenken.
